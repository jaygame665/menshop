...
<?php
$con = mysqli_connect("localhost","jnshopfo_root","12345678","jnshopfo_men");
mysqli_set_charset($con,"utf8");
?>

<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title>UThis shop for men</title>
...
<table width="901" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="176"><a href="Login.php"><img src="images/menshop_055.jpg" width="176" height="58" /></a></td>
    <td width="145"><a href="titto2.php"><img src="images/menshop_06.jpg" width="165" height="58" /></a></td>
    <td width="65"><a href="tepug - Copy (3).php"><img src="images/menshop_07.jpg" width="168" height="58" /></a></td>
  </tr>
</table>
...
<table width="1024" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="280" height="470" valign="top"><table width="100" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><a href="Aboutweb.php"><img src="images/menshop_17.jpg" width="280" height="78" /></a></td>
      </tr>
    </table>      &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;</td>
...
<img src="images/gram.jpg" width="744" height="70" />
<?php
$result = mysqli_query($con,"select * from product Where prd_status = 2");
